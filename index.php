        ...
        <section class="carousel-section">
            <div class="swiper-container carousel-section__carousel">
                <div class="swiper-wrapper">
                    <div class="swiper-slide carousel-section__slide"
                         style="background-image: url(img/admin/slide.jpg);">
                        <div class="container">
                            <h2 class="carousel-section__title">
                                Многофункциональный <br>медицинский центр <br>с высокой экспертизой <br>в лечении
                                лимфомы
                            </h2>
                        </div>
                    </div>
                ...
                <div class="row sertificates__row">
                    <div class="sertificates__desc">
                        ...
                        <p class="text sertificates__text">
                            ...
                            опытом. Наши врачи не только лечат. Они помогают сохранить здоровье и находят подход и ко
                            всем
                            пациентам.
                        </p>
